...
public sealed record class HistoricalRetrieveResponse : ModelBase
{
    ...
    public global::Phoebe.Models.Product.Lists.Historical.Loc? Loc
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<global::Phoebe.Models.Product.Lists.Historical.Loc?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public List<global::Phoebe.Models.Product.Lists.Historical.Ob>? Obs
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<global::Phoebe.Models.Product.Lists.Historical.Ob>?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
public sealed record class Ob : ModelBase
{
    public List<global::Phoebe.Models.Product.Lists.Historical.ObsAux>? ObsAux
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<global::Phoebe.Models.Product.Lists.Historical.ObsAux>?>(
                element,
                ModelBase.SerializerOptions
            );
        }
