...
public class HttpResponse : IDisposable
{
    ...
    {
        if (obj is not global::Phoebe.Core.HttpResponse other)
        {
            return false;
        }
    ...
    public async Task<T> Deserialize<T>(Threading::CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            return await JsonSerializer
                ...
                ?? throw new PhoebeInvalidDataException("Response cannot be null");
        }
...
public sealed class HttpResponse<T> : global::Phoebe.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::Phoebe.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::Phoebe.Core.HttpResponse
{
